...
void app_config_init_defaults(void)
{
    ...
    copy_string(s_snapshot.device.wifi_ssid, sizeof(s_snapshot.device.wifi_ssid), "");
    copy_string(s_snapshot.device.wifi_password, sizeof(s_snapshot.device.wifi_password), "");
    copy_string(s_snapshot.device.server_host, sizeof(s_snapshot.device.server_host), "101.200.135.73");
    s_snapshot.device.server_port = 8080U;
    copy_string(s_snapshot.device.node_id, sizeof(s_snapshot.device.node_id), "WIND_001");
    copy_string(s_snapshot.device.node_location, sizeof(s_snapshot.device.node_location), "ESP32 SPI Coprocessor");
    copy_string(s_snapshot.device.hw_version, sizeof(s_snapshot.device.hw_version), "v1.0_4CH");

...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_2, 5, 2);
    lv_obj_set_size(ui->screen_label_2, 204, 227);
    lv_label_set_text(ui->screen_label_2, "实时波形\n频谱分析\n历史记录\n系统设置\n无线网络\n采样率\n上传频率\n自动频谱\n恢复默认\n返回正常\n警告\n故障\n离线\n运行\n暂停");
    ...
    lv_obj_set_pos(ui->screen_label_3, 212, 2);
    lv_obj_set_size(ui->screen_label_3, 71, 51);
    lv_label_set_text(ui->screen_label_3, "主页\n示波器\n设置");
    ...
    lv_obj_set_pos(ui->screen_label_4, 347, 5);
    lv_obj_set_size(ui->screen_label_4, 71, 51);
    lv_label_set_text(ui->screen_label_4, "伏特\n通道\n增益");
    ...
    lv_obj_set_style_text_font(ui->screen_label_4, &lv_font_SourceHanSerifSC_Regular_14, LV_PART_MAIN|LV_STATE_DEFAULT);

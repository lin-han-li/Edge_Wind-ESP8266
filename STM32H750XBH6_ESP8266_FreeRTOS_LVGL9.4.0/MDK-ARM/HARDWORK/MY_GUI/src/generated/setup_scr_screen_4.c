...
void setup_scr_screen_4(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_4_label_1, "幅度值:255");
    lv_label_set_long_mode(ui->screen_4_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_4_label_1, 450, 100);
    lv_obj_set_size(ui->screen_4_label_1, 300, 30);
    ...
    lv_obj_set_style_text_font(ui->screen_4_label_1, &lv_font_SourceHanSerifSC_Regular_28, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_4_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_4_label_1, lv_color_hex(0x2FDAAE), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_4_label_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //   /* 定义并创建键盘 */
//   ui->screen_4_PGA_keyboard= lv_keyboard_create(ui->screen_4);

//   /* 定义并创建文本框 */
//   ui->screen_4_PGA_textarea = lv_textarea_create(ui->screen_4);

//   /* 设置文本框宽度 */

//   lv_obj_set_width(ui->screen_4_PGA_textarea, scr_act_width() - 10);

//   /* 设置文本框高度 */

//   lv_obj_set_height(ui->screen_4_PGA_textarea, (scr_act_height() >> 1) - 10);
//   lv_obj_align(ui->screen_4_PGA_textarea, LV_ALIGN_TOP_LEFT, 0, 0);

//   /* 为键盘指定一个文本区域 */
//   lv_keyboard_set_textarea(ui->screen_4_PGA_keyboard, ui->screen_4_PGA_textarea);

//   /* 开启按键弹窗 */
//   lv_keyboard_set_popovers(ui->screen_4_PGA_keyboard, true);

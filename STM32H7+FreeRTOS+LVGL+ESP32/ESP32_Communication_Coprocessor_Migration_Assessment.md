...
当前系统里的 ESP8266 已经不是一个“单纯联网模组”，而是一套 **STM32 侧主导的 AT 透传通信子系统**。真正重的工作并不在 ESP8266 内部，而在 STM32 侧：采样数据整理、FFT、JSON 拼包、HTTP 组包、命令解析、状态恢复都放在 `esp32.c` 里完成。
...
- `MDK-ARM/HARDWORK/ESP32/esp32.c:3085-3569`
...
- `MDK-ARM/HARDWORK/ESP32/esp32.c:113-177`
- `MDK-ARM/HARDWORK/ESP32/esp32.c:324-331`
...
| 功能 | 位置 | 说明 |
| --- | --- | --- |
| 编译期默认 Wi-Fi / 服务器 / Node 参数 | `esp32_config.h` | 当前文件中仍有硬编码默认配置，包含明文 Wi-Fi 密码，此文不复述 |
...
- `MDK-ARM/HARDWORK/ESP32/esp32.h:76-114`
- `MDK-ARM/HARDWORK/ESP32/esp32.c:496-829`
...
- `MDK-ARM/HARDWORK/ESP32/esp32.c:923-1106`
- `MDK-ARM/HARDWORK/ESP32/esp32.c:2507-2693`
- `MDK-ARM/HARDWORK/ESP32/esp32.c:3313-3508`
...
- `MDK-ARM/HARDWORK/ESP32/esp32.c:1194-1279`
...
- 固件接收与生效：`esp32.c:1388-1577, 2263-2373`
...
- `esp32.c:1685-1865`：摘要上传
- `esp32.c:1874-2089`：全量上传
- `esp32.c:2096-2144`：心跳上传
...
- 固件：`esp32.c:1388-1577, 1737-1741, 1938-1943, 2263-2373`
...
1. **编译期默认配置里仍存在明文敏感信息**
   - `esp32_config.h:12-26` 里仍保留 Wi-Fi、服务器、节点默认值，其中包含明文 Wi-Fi 密码。
...
- `MDK-ARM/HARDWORK/ESP32/esp32_config.h:12-26`
- `Edge_Wind_System/edgewind/routes/api.py:379-399`
- `Edge_Wind_System/edgewind/routes/api.py:804-841`
- `MDK-ARM/HARDWORK/ESP32/esp32.c:1738-1757`
- `MDK-ARM/HARDWORK/ESP32/esp32.c:1949-1977`
...
- `STM32H7+FreeRTOS+LVGL+ESP32/MDK-ARM/HARDWORK/ESP32/esp32.c`
- `STM32H7+FreeRTOS+LVGL+ESP32/MDK-ARM/HARDWORK/ESP32/esp32.h`
- `STM32H7+FreeRTOS+LVGL+ESP32/MDK-ARM/HARDWORK/ESP32/esp32_config.h`
- `STM32H7+FreeRTOS+LVGL+ESP32/Core/Src/freertos.c`
- `STM32H7+FreeRTOS+LVGL+ESP32/Core/Src/usart.c`
- `STM32H7+FreeRTOS+LVGL+ESP32/Core/Src/main.c`
- `STM32H7+FreeRTOS+LVGL+ESP32/Core/Src/ad_acq_buffers.c`
- `STM32H7+FreeRTOS+LVGL+ESP32/MDK-ARM/HARDWORK/GUI-Guider_Runtime/src/generated/events_init.c`
- `STM32H7+FreeRTOS+LVGL+ESP32/MDK-ARM/HARDWORK/GUI-Guider_Runtime/src/generated/gui_guider.h`
